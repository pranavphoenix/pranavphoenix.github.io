...
permalink: /publication/pathogen
excerpt: 'A cross-modal framework that translates and aligns histopathology image features into the genomic feature space during training, achieving strong survival prediction using only imaging data at test time.'
date: 2025-04-08
venue: 'Proceedings of the 2025 IEEE 22nd International Symposium on Biomedical Imaging (ISBI), Houston TX, USA'
carousel:
  acronym: "PathoGen-X"
...
[Paper Link](https://ieeexplore.ieee.org/abstract/document/10981028)
