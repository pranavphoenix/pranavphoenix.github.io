...
excerpt: 'A computational pathology framework combining quantile-gated patch selection, graph-guided clustering, hierarchical context attention, and an expert-driven mixture of log-logistics for state-of-the-art survival prediction from whole-slide images.'
date: 2026-04-08
...
[Paper Link](https://ieeexplore.ieee.org/abstract/document/11515974)

Recommended citation: A. Sekhar, V. Soni, K. Aske, S. Madnoorkar, P. Jeevan and A. Sethi, "Spatially-Aware Mixture of Experts with Log-Logistic Survival Modeling for Whole-Slide Images," 2026 IEEE 23rd International Symposium on Biomedical Imaging (ISBI), London, United Kingdom, 2026, pp. 1-4, doi: 10.1109/ISBI61048.2026.11515974. 
