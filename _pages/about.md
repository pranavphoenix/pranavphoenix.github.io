...
<div class="relative border-l-4 border-blue-500 pl-6 pb-8">
  <!-- Latest: Samsung Internship -->
  <div class="mb-10 relative">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-blue-500 rounded-full border-4 border-white"></span>
  ...
  <!-- Sync -->
  <div class="mb-10 relative">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-purple-500 rounded-full border-4 border-white"></span>
  ...
  <!-- PhD IIT Bombay -->
  <div class="mb-10 relative">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-green-500 rounded-full border-4 border-white"></span>
  ...
  <!-- Masters IIT Kanpur -->
  <div class="mb-10 relative">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-yellow-500 rounded-full border-4 border-white"></span>
  ...
  <!-- Tata Motors -->
  <div class="mb-10 relative">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-red-500 rounded-full border-4 border-white"></span>
  ...
  <!-- IIT Madras -->
  <div class="relative">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-gray-500 rounded-full border-4 border-white"></span>
