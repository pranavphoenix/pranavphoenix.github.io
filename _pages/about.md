...
<div class="relative border-l-4 border-blue-500 pl-6 pb-8">
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-blue-500 rounded-full border-4 border-white z-10"></span>
    <div class="transition-all duration-300 bg-white group-hover:bg-blue-50 group-hover:shadow-lg rounded-lg px-4 py-2 flex items-start gap-4">
      ...
      <div>
        <div class="text-sm text-gray-500 mb-1">Jul 2023 – Jan 2024</div>
  ...
  <!-- Timeline Entry: Sync -->
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-purple-500 rounded-full border-4 border-white z-10"></span>
    <div class="transition-all duration-300 bg-white group-hover:bg-purple-50 group-hover:shadow-lg rounded-lg px-4 py-2 flex items-start gap-4">
      ...
      <div>
        <div class="text-sm text-gray-500 mb-1">Present</div>
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-green-500 rounded-full border-4 border-white z-10"></span>
    <div class="transition-all duration-300 bg-white group-hover:bg-green-50 group-hover:shadow-lg rounded-lg px-4 py-2 flex items-start gap-4">
      ...
      <div>
        <div class="text-sm text-gray-500 mb-1">Ph.D.</div>
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-yellow-500 rounded-full border-4 border-white z-10"></span>
    <div class="transition-all duration-300 bg-white group-hover:bg-yellow-50 group-hover:shadow-lg rounded-lg px-4 py-2 flex items-start gap-4">
      ...
      <div>
        <div class="text-sm text-gray-500 mb-1">M.Tech.</div>
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-red-500 rounded-full border-4 border-white z-10"></span>
    <div class="transition-all duration-300 bg-white group-hover:bg-red-50 group-hover:shadow-lg rounded-lg px-4 py-2 flex items-start gap-4">
      ...
      <div>
        <div class="text-sm text-gray-500 mb-1">First Job</div>
  ...
  <div class="relative group cursor-pointer transition-all duration-300">
    <span class="absolute -left-7 top-1 w-4 h-4 bg-gray-500 rounded-full border-4 border-white z-10"></span>
    <div class="transition-all duration-300 bg-white group-hover:bg-gray-100 group-hover:shadow-lg rounded-lg px-4 py-2 flex items-start gap-4">
      ...
      <div>
        <div class="text-sm text-gray-500 mb-1">Academia</div>
