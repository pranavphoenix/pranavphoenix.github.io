...
<div class="relative border-l-4 border-blue-500 pl-6 pb-8">
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    ...
    <div class="transition-all duration-300 bg-white group-hover:bg-blue-50 group-hover:shadow-lg rounded-lg px-4 py-2">
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    ...
    <div class="transition-all duration-300 bg-white group-hover:bg-purple-50 group-hover:shadow-lg rounded-lg px-4 py-2">
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    ...
    <div class="transition-all duration-300 bg-white group-hover:bg-green-50 group-hover:shadow-lg rounded-lg px-4 py-2">
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    ...
    <div class="transition-all duration-300 bg-white group-hover:bg-yellow-50 group-hover:shadow-lg rounded-lg px-4 py-2">
  ...
  <div class="mb-10 relative group cursor-pointer transition-all duration-300">
    ...
    <div class="transition-all duration-300 bg-white group-hover:bg-red-50 group-hover:shadow-lg rounded-lg px-4 py-2">
  ...
  <div class="relative group cursor-pointer transition-all duration-300">
    ...
    <div class="transition-all duration-300 bg-white group-hover:bg-gray-100 group-hover:shadow-lg rounded-lg px-4 py-2">
